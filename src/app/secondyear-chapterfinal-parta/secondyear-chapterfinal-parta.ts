...
@Component({
  selector: 'app-secondyear-chapterfinal-parta',
  imports: [MatIconModule, CommonModule, FormsModule],
  templateUrl: './secondyear-chapterfinal-parta.html',
  styleUrl: './secondyear-chapterfinal-parta.scss'
})
export class SecondYearChapterfinalParta {
