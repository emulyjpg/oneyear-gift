...
@Component({
  selector: 'app-secondyear-chaptereight-parta',
  imports: [MatIconModule, CommonModule, FormsModule],
  templateUrl: './secondyear-chaptereight-parta.html',
  styleUrl: './secondyear-chaptereight-parta.scss'
})
export class SecondYearChaptereightParta {
  ...
  handleKeyboardEvent(event: KeyboardEvent) {
    ...
    if(event.key == "Enter" && this.winMessage == "WIN!!") {
      this.router.navigate(['second-year/chapternine/parta']);
    }
