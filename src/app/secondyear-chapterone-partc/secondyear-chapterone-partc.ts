...
@Component({
  selector: 'app-secondyear-chapterone-partc',
  imports: [MatIconModule, CommonModule, FormsModule],
  templateUrl: './secondyear-chapterone-partc.html',
  styleUrl: './secondyear-chapterone-partc.scss'
})
export class SecondYearChapteronePartc {
