...
@Component({
  selector: 'app-secondyear-chaptersixteen-parta',
  imports: [MatIconModule, CommonModule, FormsModule],
  templateUrl: './secondyear-chaptersixteen-parta.html',
  styleUrl: './secondyear-chaptersixteen-parta.scss'
})
export class SecondYearChaptersixteenParta {
...
answer: string[] = [];
  ...
  handleKeyboardEvent(event: KeyboardEvent) {
    ...
    if(event.key == "Enter" && this.winMessage == "WIN!!") {
      this.router.navigate(['second-year/chapterseventeen/parta']);
    }
