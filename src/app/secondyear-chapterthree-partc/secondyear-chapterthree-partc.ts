...
@Component({
  selector: 'app-secondyear-chapterthree-partc',
   imports: [MatIconModule, CommonModule, FormsModule],
  templateUrl: './secondyear-chapterthree-partc.html',
  styleUrl: './secondyear-chapterthree-partc.scss'
})
export class SecondYearChapterthreePartc {
