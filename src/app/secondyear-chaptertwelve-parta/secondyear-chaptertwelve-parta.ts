...
@Component({
  selector: 'app-secondyear-chaptertwelve-parta',
  imports: [MatIconModule, CommonModule, FormsModule],
  templateUrl: './secondyear-chaptertwelve-parta.html',
  styleUrl: './secondyear-chaptertwelve-parta.scss'
})
export class SecondYearChaptertwelveParta {
...
emilyImage = 'img/emilycheer.png';
  ...
  handleKeyboardEvent(event: KeyboardEvent) {
    ...
    if(event.key == "Enter" && this.winMessage == "WIN!!") {
      this.router.navigate(['second-year/chapterthirteen/parta']);
    }
