...
@Component({
  selector: 'app-secondyear-chapterseven-parta',
  imports: [MatIconModule, CommonModule, FormsModule],
  templateUrl: './secondyear-chapterseven-parta.html',
  styleUrl: './secondyear-chapterseven-parta.scss'
})
export class SecondYearChaptersevenParta {
constructor(private router: Router) {}
  ...
  handleKeyboardEvent(event: KeyboardEvent) {
    ...
    if(event.key == "Enter" && this.winMessage == "WIN!!") {
      this.router.navigate(['second-year/chaptereight/parta']);
    }
