...
@Component({
  selector: 'app-secondyear-chapterthree-parta',
  imports: [MatIconModule, CommonModule, FormsModule],
  templateUrl: './secondyear-chapterthree-parta.html',
  styleUrls: ['./secondyear-chapterthree-parta.scss']
})
export class SecondYearChapterthreeParta {
    ...
    if (this.winMessage === "WIN!!") {
        if (event.key.toLowerCase() === "enter") {
          if (!this.hasConfirmedWin) {
            ...
            this.router.navigate(['second-year/chapterthree/partb']);
          }
        }
        return;
      }
