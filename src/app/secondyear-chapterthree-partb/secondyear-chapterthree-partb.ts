...
@Component({
  selector: 'app-secondyear-chapterthree-partb',
  imports: [CommonModule],
  templateUrl: './secondyear-chapterthree-partb.html',
  styleUrl: './secondyear-chapterthree-partb.scss'
})
export class SecondYearChapterthreePartb {
  ...
  handleKeyboardEvent(event: KeyboardEvent) {
    console.log('Key pressed:', event.key);
     if(event.key == "Enter" && this.winMessage == "WIN!!") {
      this.router.navigate(['second-year/chapterthree/partc']);
    }
  }
