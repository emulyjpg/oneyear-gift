...
@Component({
  selector: 'app-secondyear-chapterseventeen-parta',
  imports: [MatIconModule, CommonModule, FormsModule],
  templateUrl: './secondyear-chapterseventeen-parta.html',
  styleUrl: './secondyear-chapterseventeen-parta.scss'
})
export class SecondYearChapterseventeenParta {
