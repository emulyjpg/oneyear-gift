...
@Component({
  selector: 'app-secondyear-chapterzero',
  standalone: true,
  imports: [CommonModule, FormsModule],
  templateUrl: './secondyear-chapterzero.html',
  styleUrls: ['./secondyear-chapterzero.scss']
})
export class SecondYearChapterzeroComponent {
