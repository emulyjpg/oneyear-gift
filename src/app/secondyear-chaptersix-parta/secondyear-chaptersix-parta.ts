...
@Component({
  selector: 'app-secondyear-chaptersix-parta',
  imports: [MatIconModule, CommonModule, FormsModule],
  standalone: true,
  templateUrl: './secondyear-chaptersix-parta.html',
  styleUrl: './secondyear-chaptersix-parta.scss'
})
export class SecondYearChaptersixParta {
